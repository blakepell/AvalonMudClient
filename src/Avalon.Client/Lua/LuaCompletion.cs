    ...
    public static class LuaCompletion
    {
        ...
        public static void LoadCompletionData(IList<ICompletionData> data, string pattern)
        {
            if (pattern == "lua")
            {
                ...
                data.Add(new LuaCompletionData("ShowVariable", "Shows a variable in the variable repeater if the key is found.\r\nSyntax: ShowVariable(string key)"));
                data.Add(new LuaCompletionData("HideVariable", "Hides a variable in the variable repeater if the key is found.\r\nSyntax: HideVariable(string key)"));
                ...
                data.Add(new LuaCompletionData("SetText", "Sets the text on the specified UI element.  If the target is omitted the main status bar label is used.\r\nSyntax: SetText(string text)\r\nSyntax: SetText(string text, string iconName)\r\nSyntax: SetText(string text, int target, string icon)"));
