...
namespace MoonSharp.Interpreter
{
    ...
    public class ScriptRuntimeException : InterpreterException
    {
        ...
        {
            return new ScriptRuntimeException("cannot find a conversion from a MoonSharp {0} to a clr {1}",
        ...
        {
            return new ScriptRuntimeException("attempt to access instance member {0} from a static userdata",
                desc.Name);
        }
