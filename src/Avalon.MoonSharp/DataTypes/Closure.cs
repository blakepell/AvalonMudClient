...
namespace MoonSharp.Interpreter
{
    ...
    public class Closure : RefIdObject, IScriptPrivateResource
    {
        ...
        /// </summary>
        private static ClosureContext _emptyClosure = new ClosureContext();
        ...
        internal Closure(Script script, int idx, SymbolRef[] symbols, IEnumerable<DynValue> resolvedLocals)
        {
            ...
            {
                this.ClosureContext = _emptyClosure;
            }
        }
        ...
        {
            int count = this.GetUpvaluesCount();
            ...
            if (count == 1 && this.GetUpvalueName(0) == WellKnownSymbols.ENV)
            {
