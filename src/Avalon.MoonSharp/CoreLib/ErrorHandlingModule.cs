...
namespace MoonSharp.Interpreter.CoreLib
{
    ...
    public class ErrorHandlingModule
    {
        ...
        {
            return SetErrorHandlerStrategy(executionContext._ecToken, "pcall", executionContext, args, null);
        }
        ...
        public static DynValue xpcall(ScriptExecutionContext executionContext, CallbackArguments args)
        {
            ...
            return SetErrorHandlerStrategy(executionContext._ecToken, "xpcall", executionContext,
                new CallbackArguments(a, false), handler);
        }
    }
}