...
namespace MoonSharp.Interpreter.Interop
{
    ...
    public class OverloadedMethodMemberDescriptor : IOptimizableDescriptor, IMemberDescriptor, IWireableDescriptor
    {
        ...
        public void PrepareForWiring(Table t)
        {
            ...
            {
                var sd = m as IWireableDescriptor;
                ...
                {
                    mst.Table.Set(++i,
                        DynValue.NewString($"unsupported - {m.GetType().FullName} is not serializable"));
                }
            }
        }
        ...
        {
            bool extMethodCacheNotExpired = this.IgnoreExtensionMethods || (obj == null) ||
            ...
            if (extMethodCacheNotExpired)
            {
                ...
                {
                    if (m_Cache[i] != null && this.CheckMatch(obj != null, args, m_Cache[i]))
                    {
            ...
            for (int i = 0; i < m_Overloads.Count; i++)
            {
                ...
                {
                    int score = this.CalcScoreForOverload(context, args, m_Overloads[i], false);
            ...
            if (!this.IgnoreExtensionMethods && (obj != null))
            {
                ...
                {
                    int score = this.CalcScoreForOverload(context, args, m_ExtOverloads[i], true);
            ...
            {
                this.Cache(obj != null, args, bestOverload);
            ...
            for (int i = 0; i < method.Parameters.Length; i++)
            {
                ...
                if (i == method.Parameters.Length - 1 && method.VarArgsArrayType != null)
                {
                    ...
                    while (true)
                    {
                        ...
                        int score = CalcScoreForSingleArgument(method.Parameters[i], method.VarArgsElementType, arg,
                            false);
                ...
                else
                {
                    ...
                    int score = CalcScoreForSingleArgument(method.Parameters[i], parameterType, arg,
        ...
        {
            return (context, args) => this.PerformOverloadedCall(script, obj, context, args);
        }
